...
from Problems.BenchmarksResNet import NavierStokes_VIDON, ShearLayer, EquationModel
...
print("#####################################################")
print("Training ResNet on ", device)
print("#####################################################")
...
for epoch in range(epochs):
    with tqdm(unit="batch", disable=False) as tepoch:
        ...
        for step, (input_batch, output_batch) in enumerate(train_loader):
            ...
            assert (output_batch.shape==output_pred_batch.shape)
