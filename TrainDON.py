...
from Problems.BenchmarksDON import NavierStokes_VIDON, ShearLayer, EquationModel
...
if len(sys.argv) == 1:
    ...
    folder = "TrainedModels/DON_model_" + which_example + "_copy2`"
...
for epoch in range(epochs):
    with tqdm(unit="batch", disable=False) as tepoch:
        ...
        for step, (input_batch, output_batch) in enumerate(train_loader):
            ...
            output_pred_batch = model(input_batch, example.trunk_inputs)
